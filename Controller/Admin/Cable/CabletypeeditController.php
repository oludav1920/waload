<?php
include($_SERVER["DOCUMENT_ROOT"]."/Command/Admin/Cable/Cabletypeedit.php");
if($_SERVER["REQUEST_METHOD"] ==="POST"){
    if(isset($_POST["cable_typeedit"])){
        ...
        $backendResponse = $Cabletypeedit->Cabletypeedit($nato, $stato, $disto, $ato, $idx);
