...
<form action="/Controller/Admin/Data/DataplanController.php" method="POST" enctype="multipart/form-data" >
    ...
    <input type="text" name="plan" class="input" placeholder="input the plan"/><br/></P><hr/>
...
<button type="submit" value="dataplan" name="data_plan" class="regbtn">Submit</button>
</form>
</fieldset>
    </div>
