...
<form action="/Controller/Admin/Data/DatatypeController.php" method="POST" enctype="multipart/form-data" >
    ...
    <P><tr><label class="lab">Type:</label><br/>
    <input type="text" name="typ" class="input" placeholder="input the type"/><br/></P><hr/>
...
<button type="submit" value="datatype" name="data_type" class="regbtn">Submit</button>
</form>
</fieldset>
    </div>
