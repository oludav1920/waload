...
<form action="/Controller/Admin/Cable/CabletypeController.php" method="POST" enctype="multipart/form-data" >
...
<button type="submit" value="cabletype" name="cable_type" class="regbtn">Submit</button>
</form>
</fieldset>
    </div>
