...
<?php include($_SERVER["DOCUMENT_ROOT"]."/Admin/left.php") ?>
 ...
 <?php
        ...
        $q = $conn->prepare("SELECT * FROM cable_plan WHERE Index_Id=:em");
...
<form action="/Controller/Admin/Cable/CableplaneditController.php" method="POST" enctype="multipart/form-data" >
...
<button type="submit" value="cabletype" name="cable_planedit" class="regbtn">Submit</button>
</form>
</fieldset>
    </div>
