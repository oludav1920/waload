...
<ul class="ul1" type="none">
    ...
    <fieldset class="divr" >
<form action="/Controller/Admin/LoginAdmin/AdminLogController.php" method="POST" enctype="multipart/form-data" >
...
<button type="submit" value="Login" name="adminlog_user" class="regbtn">Login</button>
</form>
</fieldset>
<p>Forget Password? <a href="/View/public/adminresetp1.php" style="text-decoration: none;">Click Here</a></p>
<P>You've not register? <a href="/View/public/adminreg.php" style="text-decoration: none;">Register Here</a></P>
