        ...
        <div class="div1">
          ...
          <ul class="ul1" type="none">
            ...
            <fieldset class="fieldset">
              ...
              <p><li id="no3" class="li3"><button><a href="/View/public/adminreg.php" class="a1">Register</a></button></li></P>
              <li id="no4" class="li3"><button><a href="/View/public/adminlog.php" class="a1">Login</a></button></li>
              </ul>
              </div>
            </fieldset>
          </li>
...
<form action="/Controller/AdminRegController.php" method="POST" enctype="multipart/form-data" >
    ...
    <P><label  class="lab">ACCESS CODE:</label><br/>
    <input type="password" name="code" class="input" placeholder="insert your access code" value=""/><br/></P><hr/>
    <P><label  class="lab">PASSWORD:</label><br/>
    <input type="password" name="ypass" class="input" placeholder="input your password"/><br/></P><hr/>
    <button type="submit" value="Register" name="adminreg_user" class="regbtn">Submit</button>
</form>
    </fieldset>
    <P>Have you registered before? <a href="/View/public/adminlog.php" style="text-decoration: none;">LOGIN</a></P>
