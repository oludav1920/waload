...
<ul class="ul1" type="none">
    ...
    ?>
    <fieldset class="divr" >
<form action="/Controller/adminForgetPassController.php" method="POST" enctype="multipart/form-data" >
...
<p><a href="/View/public/adminlog.php">Login</a></p>
<P>Don't have an account ? <a href="/View/public/adminreg.php">Register Here</a></P>
</div>
<footer>
